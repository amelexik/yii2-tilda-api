...
class TildaExportPage
{
    ...
    public function __construct(Array $response, Array $responseProject, $assetsPath, $assetsUrl)
    {
        ...
        if(isset($responseProject['customcssfile']) && !empty($responseProject['customcssfile']))
            $this->html = Html::cssFile($responseProject['customcssfile']) . $this->html;
